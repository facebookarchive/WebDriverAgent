...
{
  return @[
    [[FBRoute GET:@"/alert/text"] respondWithBlock: ^ id<FBResponsePayload> (FBRouteRequest *request) {
    ...
    [[FBRoute POST:@"/alert/accept"] respondWithBlock: ^ id<FBResponsePayload> (FBRouteRequest *request) {
    ...
    [[FBRoute POST:@"/alert/dismiss"] respondWithBlock: ^ id<FBResponsePayload> (FBRouteRequest *request) {
