...
@interface TVXCUIDeviceHelperTests : FBTVIntegrationTestCase
@end

@implementation TVXCUIDeviceHelperTests
...
- (void)testGoToHomeScreen
{
  ...
  XCTAssertNil(error);
  XCTAssertTrue([FBApplication fb_activeApplication].icons[@"Settings"].exists);
}
