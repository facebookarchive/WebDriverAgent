...
@interface TVXCUIElementAttributesTests : FBTVIntegrationTestCase
@property (nonatomic, strong) XCUIElement *matchingElement;
@end

@implementation TVXCUIElementAttributesTests
...
- (void)testGetFocusedAttribute
{
  [self verifyGettingAttributeWithShortcut:@"focused" expectedValue:[NSNumber numberWithBool:self.matchingElement.wdFocused]];
}
