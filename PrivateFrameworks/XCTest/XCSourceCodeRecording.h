...
@property (atomic, retain) NSMutableDictionary *variableNameToContentNodeDictionary;
@property (atomic, copy, setter=_setTreeNodes:) NSArray *_treeNodes;
@property (atomic, readonly) unsigned long long language;
